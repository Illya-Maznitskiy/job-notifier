...
from db.models import Job, UserFilteredJob
from logs.logger import logger
from notifier.telegram.bot_config import dp
from aiogram.filters import Command

from notifier.telegram.job_utils import get_or_create_user
from utils.job_filter import filter_jobs_for_user
from db.crud.user_filtered_jobs import create_user_filtered_job
...
async def refresh_jobs(message: types.Message):
    ...
    await message.answer(
        f"✅ Found {len(filtered_jobs)} relevant jobs. Use /next to browse."
    )
